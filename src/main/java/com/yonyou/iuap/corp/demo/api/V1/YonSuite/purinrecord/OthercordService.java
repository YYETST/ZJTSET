 ...
 */
@Component
public class OthercordService extends BaseApi {

    private static final Logger logger = LoggerFactory.getLogger(OthercordService.class);

    @Value("${api.othinrecord.list}")
    private String list_uri;
    @Value("${api.othinrecord.detail}")
    private String detail_uri;
    @Value("${api.othinrecord.save}")
